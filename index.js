...
exports.default = {
    ...
    'anarchist': ['anarchy'],
    'angelenos': ['angel'],
    'anotherloverholenyohead': ['another', 'love', 'hole', 'n', 'in', 'yo', 'head'],
    'answerphone': ['answer', 'phone'],
    'antisocial': ['anti', 'social'],
    'anutha': ['another'],
    'anziety': ['anxiety'],
    'appleblossom': ['apple', 'blossom'],
    'aquababe': ['aqua', 'babe'],
    'armless': ['arm'],
    'ashtrobot': ['ash', 'robot'],
    'askling': ['ask'],
    'astrodome': ['astro', 'dome'],
    'astronomyy': ['astro'],
    ...
    'b00ty': ['booty'],
    'babydoll': ['baby', 'doll'],
    'backstreets': ['back', 'street'],
    'backtight': ['back', 'tight'],
    'badwayz': ['bad', 'way'],
    'baldhead': ['bald', 'head'],
    'ballaholic': ['ball'],
    'Ballinnn': ['ball'],
    ...
    'bandman': ['band', 'man'],
    'bankhead': ['bank', 'head'],
    'bankwrapped': ['bank', 'wrap'],
    'bankx': ['bank'],
    'banky': ['bank'],
    'banx': ['bank', 'ban'],
    'barbwire': ['barb', 'wire'],
    'barefootin': ['bare', 'foot'],
    'barfly': ['bar', 'fly'],
    'barretender': ['barre', 'bar', 'tend'],
    'bartender': ['bar', 'tend'],
    'baseline': ['base', 'line'],
    'bashy': ['bash'],
    'bassface': ['bass', 'face'],
    'bassjackers': ['bass', 'jack'],
    'batshit': ['bat', 'shit'],
    'baynk': ['bank'],
    'baytoven': ['bay', 'beethoven'],
    'bbd': ['b', 'd'],
    'bbo': ['b', 'o'],
    'beamin': ['beam'],
    'bearcub': ['bear', 'cub'],
    ...
    'bearface': ['bear', 'face'],
    'beastin': ['beast'],
    'beastleague': ['beast', 'league'],
    'beatem': ['beat', 'em'],
    'beatminerz': ['beat', 'mine'],
    'bedstudy': ['bed', 'study'],
    'beehive': ['bee', 'hive'],
    'befo': ['before'],
    'beggars': ['beg'],
    'bellwoods': ['bell', 'wood'],
    'benchwarmer': ['bench', 'warm'],
    'benchwarmers': ['bench', 'warm'],
    'benji3000': ['benji', '3', 'thousand', '0'],
    ...
    'bhabie': ['baby'],
    'bhad': ['bad'],
    'bichasbootleguz': ['bitch', 'ass', 'boot', 'leg'],
    'bichasniguz': ['bitch', 'ass', 'nigga'],
    'bickenhead': ['bicken', 'chicken', 'head'],
    'bigface': ['big', 'face'],
    'bigga': ['big'],
    'biggy': ['big'],
    'birdies': ['bird'],
    'birdsongs': ['bird', 'song'],
    'birdwatcher': ['bird', 'watch'],
    ...
    'blingblingbling': ['bling'],
    'blk': ['black'],
    'blocko': ['block'],
    'blocksdale': ['block', 'dale'],
    ...
    'bluffin': ['bluff'],
    'blvkstar': ['black', 'star'],
    'bobiverse': ['bob', 'universe'],
    'bodyback': ['body', 'back'],
    'bodyrock': ['body', 'rock'],
    'bollective': ['collective'],
    'boomtown': ['boom', 'town'],
    'boomtrap': ['boom', 'trap'],
    'booti': ['booty'],
    'bootsee': ['boot'],
    'bottlebag': ['bottle', 'bag'],
    'bottlebags': ['bottle', 'bag'],
    'bottlez': ['bottle'],
    'bowlzzz': ['bowl'],
    'boxframe': ['box', 'frame'],
    'boyish': ['boy'],
    ...
    'bumrush': ['bum', 'rush'],
    'bunky': ['bunk'],
    'burrrprint': ['burr', 'print'],
    'bussdown': ['bust', 'down'],
    'bustaclip': ['bust', 'clip'],
    'butterflyz': ['butter', 'fly'],
    ...
    'caddillac': ['cadillac'],
    'caint': ['can'],
    'califoolya': ['cali', 'fool'],
    'candlelight': ['candle', 'light'],
    'candycars': ['candy', 'car'],
    'cantfuckwithme': ['can', 'fuck', 'with', 'me'],
    'cantfuckwithus': ['can', 'fuck', 'with', 'us'],
    'cappadonna': ['cap', 'donna'],
    'cappin': ['cap'],
    'caramelize': ['caramel'],
    'carpool': ['car', 'pool'],
    'carpoolin': ['car', 'pool'],
    ...
    'cfwu': ['c', 'f', 'w', 'u'],
    'chace': ['chase'],
    'chachiville': ['chachi', 'ville'],
    'chainsmoke': ['chain', 'smoke'],
    'champagnechroniknightcap': ['champagne', 'chronic', 'night', 'knight', 'cap'],
    'chasen': ['chase'],
    'checc': ['check'],
    ...
    'cheeze': ['cheese'],
    'chevytown': ['chevy', 'town'],
    'chewy': ['chew'],
    'chikk': ['chick'],
    'chip$': ['chip'],
    'chippass': ['chip'],
    'chokechain': ['choke', 'chain'],
    'chokin': ['choke'],
    'chopsticks': ['chop', 'stick'],
    'chozen': ['chosen', 'chose'],
    'christchurch': ['christ', 'church'],
    'chullin': ['children'],
    'cityy1000': ['city', '1', '0', 'thousand'],
    'cityyy': ['city'],
    'clapper': ['clap'],
    'claymation': ['clay'],
    'cld': ['cloud'],
    ...
    'cookbooks': ['cook', 'book'],
    'coolbrothajones': ['cool', 'brother', 'jones'],
    'cornerboy': ['corner', 'boy'],
    'correy': ['corey'],
    'coughphee': ['cough', 'coffee'],
    'couldve': ['could'],
    'craccin': ['crack'],
    'crackpot': ['crack', 'pot'],
    'craka': ['cracker'],
    ...
    'crazyhot': ['crazy', 'hot'],
    'cribbo': ['crib'],
    'crimeapple': ['crime', 'apple'],
    'crookers': ['crook'],
    'crunkest': ['crunk'],
    'crystalfilm': ['crystal', 'film'],
    'cusswords': ['cuss', 'word'],
    'cutthroat': ['cut', 'throat'],
    'cviro': ['cairo'],
    'cyberlove': ['cyber', 'love'],
    'd evils': ['devil', 'd', 'evil'],
    'damageplan': ['damage', 'plan'],
    'darehego': ['dare', 'he', 'go'],
    'darkened': ['dark'],
    'darkman': ['dark', 'man'],
    'datdreamin': ['that', 'dream'],
    'dawnbreaker': ['dawn', 'break'],
    'dawreck': ['wreck'],
    'daybreak': ['day', 'break'],
    'daydreaming': ['day', 'dream'],
    'daytrip': ['day', 'trip'],
    'dboy': ['d', 'boy'],
    'dcmbr': ['december'],
    'deadend': ['dead', 'end'],
    'deadendredd': ['dead', 'end', 'red'],
    'deadline': ['dead', 'line'],
    'deadlines': ['dead', 'line'],
    'deadringer': ['dead', 'ring'],
    'deafheaven': ['deaf', 'heaven'],
    'deathcamp': ['death', 'camp'],
    'deathgrip': ['death', 'grip'],
    'deathgrips': ['death', 'grip'],
    'deathstar': ['death', 'star'],
    'decadez': ['decade'],
    'deebuzz': ['dee', 'buzz'],
    'demigods': ['demi', 'god'],
    'detectorists': ['detect'],
    'detroit187': ['detroit', '1', '8', '7'],
    'devilish': ['devil'],
    'df': ['d', 'f'],
    'di$respectful': ['respect'],
    'diamondz': ['diamond'],
    'digga': ['dig'],
    'digitalism': ['digital'],
    'diine': ['down'],
    ...
    'dodgin': ['dodge'],
    'doggz': ['dog'],
    'dollabillgates': ['dollar', 'bill', 'gate'],
    'dontgetit': ['dont', 'get', 'it'],
    'dopefiend': ['dope', 'fiend'],
    'dopefiends': ['dope', 'fiend'],
    'dopehead': ['dope', 'head'],
    'dopemang': ['dope', 'man'],
    'dopesmoothies': ['dope', 'smooth', 'smoothie'],
    ...
    'dywm': ['d', 'y', 'w', 'm'],
    'e^st': ['east'],
    'earthgang': ['earth', 'gang'],
    'eastland': ['east', 'land'],
    'easybeats': ['easy', 'beat'],
    'ebonylove': ['ebony', 'love'],
    'ededdneddy': ['ed', 'n'],
    ...
    'endanger': ['danger'],
    'enemiesz': ['enemy'],
    'entaprizin': ['enterprise'],
    'esgn': ['e', 's', 'g', 'n'],
    'everlasting': ['ever', 'last'],
    'everlovin': ['ever', 'love'],
    'exfiles': ['ex', 'file'],
    'extendo': ['extend'],
    'eyestone': ['eye', 'stone'],
    ...
    'fatts': ['fat'],
    'fav': ['favorite'],
    'feeltherage': ['feel', 'rage'],
    'feets': ['feet'],
    'fergivicious': ['ferg', 'vicious'],
    'figga': ['figure'],
    'firebreather': ['fire', 'breath'],
    ...
    'fittest': ['fit'],
    'fiyayaya': ['fire'],
    'flamethrower': ['flame', 'throw'],
    'flamezesz': ['flame'],
    'flatliners': ['flat', 'line'],
    'flipp': ['flip'],
    'flipside': ['flip', 'side'],
    'flooded': ['flood'],
    'floodgate': ['flood', 'gate'],
    'floodgates': ['flood', 'gate'],
    'floorboard': ['floor', 'board'],
    'flymuthafucka': ['fly', 'mother', 'fuck'],
    'foldout': ['fold', 'out'],
    'foolies': ['fool'],
    'foreal': ['for', 'real'],
    'foreclosure': ['fore', 'close'],
    'foreclosures': ['fore', 'close'],
    'forevermore': ['for', 'ever', 'more'],
    'forgeeauto': ['forgee', 'auto'],
    'forklift': ['fork', 'lift'],
    'forklifts': ['fork', 'lift'],
    'fortebowie': ['forte', 'bowie'],
    'fortnite': ['fort', 'night'],
    'fortunato': ['fortune', 'auto'],
    'frakzanatcha': ['freak', 'nature'],
    'freakanomics': ['freak'],
    ...
    'freeloaders': ['free', 'load'],
    'freemason': ['free', 'mason'],
    'freemasons': ['free', 'mason'],
    'frenchy': ['french'],
    'frfr': ['f', 'r'],
    'friendamine': ['friend', 'mine'],
    'ftr': ['f', 't', 'r'],
    'fucka': ['fuck'],
    'fuckery': ['fuck'],
    'fuhgidabowdit': ['forget', 'about', 'it'],
    'fuks': ['fuck'],
    'funroom': ['fun', 'room'],
    'futureback': ['future', 'back'],
    'fwyb': ['f', 'w', 'y', 'b'],
    'fyfr': ['f', 'y', 'r'],
    'fyre': ['fire'],
    'g$fb': ['g', 's', 'f', 'b'],
    ...
    'giv': ['give'],
    'glassman': ['glass', 'man'],
    'glockapella': ['glock', 'acapella', 'cappella'],
    ...
    'godbody': ['god', 'body'],
    'godmode': ['god', 'mode'],
    'goingtohell': ['go', 'to', 'hell'],
    'golddust': ['gold', 'dust'],
    'goldielocks': ['gold', 'lock'],
    'goldrush': ['gold', 'rush'],
    'goodchild': ['good', 'child'],
    'goodfriend': ['good', 'friend'],
    'goodlife': ['good', 'life'],
    'goodmorning': ['good', 'morning'],
    'goodnewsbadnews': ['good', 'new', 'bad'],
    'goonbody': ['good', 'body'],
    'goshfather': ['gosh', 'father'],
    'gottabody': ['got', 'body'],
    'governmentalist': ['government'],
    'gpn': ['g', 'p', 'n'],
    'gpsa': ['g', 'p', 's', 'a'],
    'gr8teful': ['grateful', '8'],
    'grae': ['gray'],
    'gramms': ['gram'],
    'grandemarshall': ['grand', 'marshall'],
    'grandloves': ['grand', 'love'],
    'grasshopper': ['grass', 'hop'],
    'greedo': ['greed'],
    'greenhouse': ['green', 'house'],
    'greenthumb': ['green', 'thumb'],
    'grindmode': ['grind', 'mode'],
    'grindtime': ['grind', 'time'],
    'grooveline': ['groove', 'line'],
    'groovline': ['groove', 'line'],
    'gsfb': ['g', 's', 'f', 'b'],
    'guapdad': ['guap', 'dad'],
    'gunsmoke': ['gun', 'smoke'],
    'gyal': ['girl', 'gyal'],
    'halfnoise': ['half', 'noise'],
    'hamburger': ['ham', 'burger'],
    'hamburgers': ['ham', 'burger'],
    'hamiltones': ['hamilton', 'tone'],
    'hamsterdam': ['hamster', 'amsterdam'],
    'handcuffin': ['hand', 'cuff'],
    'handcuffing': ['hand', 'cuff'],
    'handcuffs': ['hand', 'cuff'],
    'woodcrest': ['wood', 'crest'],
    'handful': ['hand', 'full'],
    'handfull': ['hand', 'full'],
    'handstand': ['hand', 'stand'],
    'handstands': ['hand', 'stand'],
    'handwriting': ['hand', 'write'],
    'handyman': ['handy', 'man'],
    'handymen': ['handy', 'men'],
    'happytree': ['happy', 'tree'],
    'hard2def': ['hard', '2', 'def'],
    'hashtag': ['hash', 'tag'],
    'haten': ['hate'],
    'haterade': ['hate'],
    'havendale': ['haven', 'dale'],
    'hawkboy': ['hawk', 'boy'],
    'haywire': ['hay', 'wire'],
    'headbanger': ['head', 'bang'],
    'headboard': ['head', 'board'],
    'headspace': ['head', 'space'],
    'headstone': ['head', 'stone'],
    'headstones': ['head', 'stone'],
    'heartbreakcity': ['heart', 'break', 'city'],
    'heartwrecker': ['heart', 'wreck'],
    'heaux': ['hoe'],
    'heavyweights': ['heavy', 'weight'],
    'hellkilla': ['hell', 'kill'],
    'hellrazor': ['hell', 'razor'],
    'herbaliser': ['herb'],
    'herre': ['here'],
    'hheh': ['h', 'e'],
    'highasakite': ['high', 'as', 'a', 'kite'],
    'highroller': ['high', 'roll'],
    'highrollers': ['high', 'roll'],
    'hiphop': ['hip', 'hopp'],
    'hisside': ['his', 'side'],
    'hitstick': ['hit', 'stick'],
    'hoeing': ['hoe'],
    'hollalude': ['holler'],
    'holyfield': ['holy', 'field'],
    'homeboyz': ['home', 'boy'],
    'homerun': ['home', 'run'],
    'homeshake': ['home', 'shake'],
    'hometeam': ['home', 'team'],
    'homewards': ['home', 'ward'],
    'honeycomb': ['honey', 'comb'],
    'honeyz': ['honey'],
    'hongkongaton': ['hong', 'kong'],
    'hoodlove': ['hood', 'love'],
    'hoodstars': ['hood', 'star'],
    'hoodstarz': ['hood', 'star'],
    'hootnanny': ['hoot', 'nanny'],
    'hooverphonic': ['hoover', 'phonic'],
    'hotdamalama': ['hot', 'damn'],
    'hotpocket': ['hot', 'pocket'],
    'housefire': ['house', 'fire'],
    'housewives': ['house', 'wife', 'wives'],
    'houstalantavegas': ['houston', 'atlanta', 'vegas'],
    'huckleberry': ['huck', 'berry'],
    'hucksters': ['huck'],
    'humdinger': ['hum', 'ding'],
    'humpin': ['hump'],
    ...
    'hyyerr': ['high'],
    'iamnobodi': ['i', 'am', 'no', 'body'],
    'iceman': ['ice', 'man'],
    'icewear': ['ice', 'wear'],
    'ididntreallymeantoturnuout': ['i', 'did', 'really', 'mean', 'to', 'turn', 'u', 'out'],
    'iiidrops': ['i', 'drop'],
    'imjaehall': ['im', 'jae', 'hall'],
    'in2': ['in', '2'],
    'indescribable': ['describe'],
    'indwelling': ['dwell'],
    'infield': ['in', 'field'],
    'ingleworld': ['inglewood', 'world'],
    'innermission': ['inner', 'mission'],
    'innerprize': ['inner', 'prize'],
    'invisibility': ['invisible'],
    'irevolutionary': ['revolution', 'i'],
    'irregular': ['regular'],
    'isay': ['i', 'say'],
    'isthatwhatyousaid': ['is', 'that', 'what', 'you', 'said'],
    'isuppose': ['i', 'suppose'],
    'iwanteweback': ['i', 'want', 'we', 'back'],
    'jackolantern': ['jack', 'lantern'],
    'jackolanterns': ['jack', 'lantern'],
    'jailbroken': ['jail', 'broke'],
    'jakk': ['jack'],
    'jammable': ['jam'],
    'jarren': ['jarron'],
    'jaydayoungan': ['jay', 'da', 'young'],
    'jerz': ['jersey'],
    'jetpacks': ['jet', 'pack'],
    'jetsgo': ['jet', 'go'],
    ...
    'jlc': ['j', 'l', 'c'],
    'jlr': ['j', 'l', 'r'],
    'jodyhighroller': ['jody', 'high', 'roll'],
    'jughead': ['jug', 'head'],
    'junglepussy': ['jungle', 'pussy'],
    'justbrittany': ['just', 'brit'],
    'k$upreme': ['k', 'supreme'],
    'k4kk': ['k', '4'],
    'kailee': ['kaley'],
    'kalifornia': ['cali'],
    ...
    'kickback': ['kick', 'back'],
    'kiddo': ['kid'],
    'killafornia': ['kill', 'cali'],
    'killr': ['kill'],
    'killuminati': ['kill', 'illuminati'],
    'kimie': ['kim'],
    'kingsavage': ['king', 'savage'],
    'kingz': ['king'],
    'klapp': ['clap'],
    'klassicks': ['classic'],
    'klick': ['click'],
    'knockturnal': ['knock', 'nocturnal'],
    'knowmatic': ['know', 'matic'],
    'knowwhatimsayin': ['know', 'what', 'im', 'sayin'],
    'kocaine': ['cocaine'],
    'kod': ['k', 'o', 'd'],
    'koffee': ['coffee'],
    'kokane': ['cocaine'],
    'kokayne': ['cocaine'],
    'kollision': ['collision'],
    'kolorblind': ['color', 'blind'],
    'koolin': ['cool'],
    'kop': ['cop'],
    'kourtney': ['courtney'],
    'kristyn': ['kristin'],
    'kronik': ['chronic'],
    'kronologik': ['chronologic'],
    'ksupreme': ['k', 'supreme'],
    'L490': ['l', '4', '9', '0'],
    'l8r': ['late', '8'],
    'lackin': ['lack'],
    ...
    'leano': ['lean'],
    'lef': ['left'],
    'letsomebodyluvu': ['let', 'some', 'body', 'love', 'u'],
    'lettetznow': ['let', 'it', 'snow'],
    'levygrey': ['levy', 'grey'],
    'lexii': ['lexi'],
    'lie4': ['lie', '4'],
    'lifestyles': ['life', 'style'],
    'lightsabers': ['light', 'saber'],
    'lightwork': ['light', 'work'],
    'lik': ['lick'],
    'lilbootycall': ['lil', 'booty', 'call'],
    'lildurk2x': ['lil', 'durk', '2', 'x'],
    'lilskiesfuneral': ['lil', 'sky', 'funeral'],
    'limestone': ['lime', 'stone'],
    'limitation': ['limit'],
    'limitedless': ['limit'],
    'limitless': ['limit'],
    'livewithoutyou': ['live', 'with', 'out', 'you'],
    'loaders': ['load'],
    'logout': ['log', 'out'],
    'lollypops': ['lolli', 'pop'],
    'longterm': ['long', 'term'],
    ...
    'lopes': ['lopez'],
    'losses': ['loss'],
    'lougotcash': ['lou', 'got', 'cash'],
    'lovaas': ['love'],
    'lovelier': ['love'],
    'loverance': ['love', 'rance'],
    'lovetap': ['love', 'tap'],
    'lowdown': ['low', 'down'],
    'lowercase': ['low', 'case'],
    'lsdskitrip': ['l', 's', 'd', 'ski', 'trip', 'lsd'],
    'ltm': ['l', 't', 'm'],
    'lukewarm': ['luke', 'warm'],
    'lungies': ['lunge'],
    'luva': ['love'],
    ...
    'm3': ['m', '3'],
    'macbook': ['mack', 'book'],
    'machinedrum': ['machine', 'drum'],
    'mackenzie': ['mckenzie'],
    'madhouse': ['mad', 'house'],
    'madusacomplex': ['madusa', 'complex'],
    'majik': ['magic'],
    'major9': ['major', '9'],
    'mak': ['mack'],
    ...
    'maxo': ['max'],
    'maxxberry': ['max', 'berry'],
    'mayback': ['may', 'back', 'maybach'],
    'mc5': ['m', 'c', '5'],
    'mcduck': ['duck'],
    'mealticket': ['meal', 'ticket'],
    'meetsims': ['meet', 'sims'],
    'megablast': ['mega', 'blast'],
    'merrygoround': ['merry', 'go', 'round'],
    'merrymaking': ['merry', 'make'],
    'messersmith': ['messer', 'smith'],
    'metamodern': ['meta', 'modern'],
    'meyhem': ['mayhem'],
    'mfpoty': ['m', 'f', 'poty'],
    'michicant': ['michigan', 'cant'],
    'mightve': ['might'],
    'mightyfools': ['mighty', 'fool'],
    'milkavelli': ['milk', 'mikavelli'],
    'mindcraft': ['mind', 'craft'],
    'mindfall': ['mind', 'fall'],
    'mindspin': ['mind', 'spin'],
    'misdirected': ['direct'],
    'mistah': ['mister'],
    ...
    'moonraker': ['moon', 'rake'],
    'moonrocks': ['moon', 'rock'],
    'moontrekkers': ['moon', 'trek'],
    'moonwalk': ['moon', 'walk'],
    'moonwalker': ['moon', 'walk'],
    'moonwalking': ['moon', 'walk'],
    'mostack': ['mo', 'stack'],
    'mothafucka': ['mother', 'fuck'],
    'mothafuckin': ['mother', 'fuck'],
    'mothafucking': ['mother', 'fuck'],
    'motherboard': ['mother', 'board'],
    'motherfuckin': ['mother', 'fuck'],
    'motherfucking': ['mother', 'fuck'],
    'mothership': ['mother', 'ship'],
    'motiv8': ['motivate', '8'],
    'mpe': ['m', 'p', 'e'],
    'MSTRKRFT': ['m', 's', 't', 'r', 'k', 'f', 'master', 'craft'],
    'muddollaz': ['mud', 'dollar'],
    'mudhut': ['mud', 'hut'],
    'muh': ['mother'],
    ...
    'narco': ['narc'],
    'narcs': ['narc'],
    'nbayoungboat': ['n', 'b', 'a', 'young', 'boat'],
    'neednt': ['need'],
    'nerdout': ['nerd', 'out'],
    'neu': ['new'],
    'neveralone': ['never', 'alone'],
    'neverending': ['never', 'end'],
    'neverfade': ['never', 'fade'],
    'newyorksoul': ['new', 'york', 'soul'],
    ...
    'outsmart': ['out', 'smart'],
    'overcomes': ['over', 'come'],
    'overcoming': ['over', 'come'],
    'overdosed': ['over', 'dose'],
    'overflow': ['over', 'flow'],
    'overflowed': ['over', 'flow'],
    'overflowing': ['over', 'flow'],
    'overlap': ['over', 'lap'],
    'overlapped': ['over', 'lap'],
    'overloaded': ['over', 'load'],
    'overstimulated': ['over', 'stimulate'],
    'overstreet': ['over', 'street'],
    'overthunk': ['over', 'think'],
    'overtones': ['over', 'tone'],
    'p2thela': ['p', '2', 'the', 'l', 'a'],
    'pacifica': ['pacific'],
    'packaging': ['package'],
    'packy': ['pack'],
    'pallbearer': ['pall', 'bear'],
    'panbowl': ['pan', 'bowl'],
    'papercuts': ['paper', 'cut'],
    ...
    'photofinnish': ['photo', 'finish'],
    'picklehead': ['pickle', 'head'],
    'pimpandho': ['pimp', 'and', 'hoe'],
    'pimpinabitch': ['pimp', 'a', 'bitch'],
    'pimpology': ['pimp'],
    'plai': ['play'],
    'platune': ['platoon'],
    'playinwitme': ['play', 'with', 'me'],
    'playstation': ['play', 'station'],
    'playy': ['play'],
    'poizn': ['poison'],
    'policemen': ['police', 'man'],
    'pollywanacraka': ['polly', 'want', 'cracker'],
    'polygraph': ['poly', 'graph'],
    'popin': ['pop'],
    'pornstar': ['porn', 'star'],
    'pornstars': ['porn', 'star'],
    'posta': ['post'],
    'powerglide': ['power', 'glide'],
    ...
    'proxies': ['proxy'],
    'psk': ['p', 's', 'k'],
    'psychedelik': ['psychedelic'],
    'psychodrama': ['psycho', 'drama'],
    'pts': ['point'],
    'pumpkinhead': ['pumpkin', 'head'],
    'punchlines': ['punch', 'line'],
    'punkbitch': ['punk', 'bitch'],
    'punx': ['punk'],
    'purgatorying': ['purgatory'],
    'quacky': ['quack'],
    'quarterbackin': ['quarter', 'back'],
    'queendom': ['queen'],
    'questionaire': ['question'],
    'quiccstrikes': ['quick', 'strike'],
    ...
    'rackz': ['rack'],
    'radioman': ['radio', 'man'],
    'rainbounce': ['rain', 'bounce'],
    'raingirl': ['rain', 'girl'],
    'rainman': ['rain', 'man'],
    'rainslicker': ['rain', 'slick'],
    'rankin': ['rank'],
    'ranx': ['rank'],
    'rapsody': ['rap', 'rhapsody'],
    'rapunxel': ['rapunzel'],
    'ratha': ['rather'],
    'rawsmoov': ['raw', 'smooth'],
    'raydiation': ['radiation', 'ray'],
    'readjustment': ['adjust'],
    ...
    'ricco': ['rico'],
    'richman': ['rich', 'man'],
    'rightfernow': ['right', 'for', 'now'],
    'rightstarter': ['right', 'start'],
    'riker$': ['rikers'],
    'rimshot': ['rim', 'shot'],
    'ringtone': ['ring', 'tone'],
    'ripplin': ['ripple'],
    'roastin': ['roast'],
    'rockoutblou': ['rock', 'out', 'below'],
    'rocksteady': ['rock', 'steady'],
    'rokin': ['rock'],
    'rondonumbanine': ['rondo', 'number', 'nine'],
    'rorystonelove': ['rory', 'stone', 'love'],
    'rosehardt': ['rose', 'hard'],
    'rottin': ['rot'],
    'rowboats': ['row', 'boat'],
    'ruffest': ['rough'],
    'rumpshaker': ['rump', 'shake'],
    'runn': ['run'],
    'runnn': ['run'],
    'ruthanne': ['ruth', 'ann'],
    'ryann': ['ryan'],
    'ryattfienix': ['ryatt', 'phoenix'],
    'ryte': ['right'],
    'sac': ['sack'],
    'salesman': ['sale', 'man'],
    'samm': ['sam'],
    ...
    'shadowcasting': ['shadow', 'cast'],
    'shadowplay': ['shadow', 'play'],
    'shallou': ['shallow'],
    'shapeshifting': ['shape', 'shift'],
    'shareholder': ['share', 'hold'],
    'shareholders': ['share', 'hold'],
    'shellshock': ['shell', 'shock'],
    'shellshocked': ['shell', 'shock'],
    'shiftee': ['shift'],
    'shipmates': ['ship', 'mate'],
    'shipwreck': ['ship', 'wreck'],
    'shipwrecked': ['ship', 'wreck'],
    'shipwrecks': ['ship', 'wreck'],
    'shitted': ['shit'],
    'shomplife': ['shomp', 'life'],
    'shooter2x': ['shoot', '2', 'x'],
    'shopaholic': ['shop'],
    'shoreline': ['shore', 'line'],
    'shortchange': ['short', 'change'],
    'shotcaller': ['shot', 'call'],
    'shoutout': ['shout', 'out'],
    'showboat': ['show', 'boat'],
    'shroomz': ['shroom'],
    'shutterbugg': ['shutter', 'bug'],
    'shyt': ['shit'],
    'sickalicious': ['sick'],
    'sideshow': ['side', 'show'],
    'sidetoside': ['side', 'to'],
    'sightseeing': ['sight', 'see'],
    'silverlake': ['silver', 'lake'],
    'simmonds': ['simmons'],
    'sistamamalover': ['sister', 'mama', 'love'],
    'skandalouz': ['scandal'],
    'skinnyfromthe9': ['skinny', 'from', 'the', '9'],
    'skiptrace': ['skip', 'trace'],
    'skiptracing': ['skip', 'trace'],
    'skooby': ['scooby'],
    'skrewface': ['screw', 'face'],
    'skrrrrrrttt': ['skirt'],
    'skydrop': ['sky', 'drop'],
    'skylines': ['sky', 'line'],
    'skytech': ['sky', 'tech'],
    'slammers': ['slam'],
    'slaughtermouse': ['slaughter', 'mouse'],
    'sleepers': ['sleep'],
    'slowheart': ['slow', 'heart'],
    'slumberjack': ['slumber', 'jack'],
    'slv': ['s', 'l', 'v'],
    'smartphones': ['smart', 'phone'],
    'smbal': ['s', 'm', 'b', 'a', 'l'],
    'smts': ['s', 'm', 't'],
    'snakeskin': ['snake', 'skin'],
    'snappy': ['snap'],
    'sneaky': ['sneak'],
    'snoozefest': ['snooze', 'fest'],
    'snoozegod': ['snooze', 'god'],
    'snowcapped': ['snow', 'cap'],
    'snowflakes': ['snow', 'flake'],
    'soaky': ['soak'],
    'soleblind': ['sole', 'blind'],
    'solja': ['soldier'],
    'someday': ['some', 'day'],
    'somedays': ['some', 'day'],
    'somekinda': ['some', 'kind'],
    'somethings': ['some', 'thing'],
    'songodsuns': ['son', 'god', 'sun'],
    'sooperman': ['super', 'man'],
    'sosaman': ['sosa', 'man'],
    'sosamann': ['sosa', 'man'],
    'soulcircuit': ['soul', 'circuit'],
    'souljah': ['soldier'],
    'soulplane': ['soul', 'plane'],
    'southland': ['south', 'land'],
    'southwind': ['south', 'wind'],
    'spacejam': ['space', 'jam'],
    'spacetime': ['space', 'time'],
    'spaz': ['spazz'],
    'spazzmatik': ['spazz', 'matic'],
    'spazzola': ['spazz'],
    'speachless': ['speech'],
    'speakeasy': ['speak', 'easy'],
    'speedboat': ['speed', 'boat'],
    'speedknot': ['speed', 'knot'],
    'spinking': ['spin', 'king'],
    'spitfire': ['spit', 'fire'],
    'squadians': ['squad'],
    'squidnice': ['squid', 'nice'],
    'squidward': ['squid'],
    'staccs': ['stack'],
    ...
    'stik': ['stick'],
    'stixx': ['stick'],
    'stompdown': ['stomp', 'down'],
    'streetlife': ['street', 'life'],
    'streetlove': ['street', 'love'],
    'strengthen': ['strength'],
    'strengthening': ['strength'],
    'stresmatic': ['stress', 'matic'],
    ...
    'sumaksion': ['some', 'action'],
    'summerboy': ['summer', 'boy'],
    'summertearz': ['summer', 'tear'],
    'summerthing': ['summer', 'thing'],
    'sundowners': ['sun', 'down'],
    'sundrenched': ['sun', 'drench'],
    'sunkissed': ['sun', 'kiss'],
    'supaman': ['super', 'man'],
    'supastars': ['super', 'star'],
    'superbad': ['super', 'bad'],
    'superego': ['super', 'ego'],
    'superfood': ['super', 'food'],
    'superhuman': ['super', 'human'],
    'superlover': ['super', 'love'],
    'superpower': ['super', 'power'],
    'superpowers': ['super', 'power'],
    'supersoka': ['super', 'soak'],
    'supersoulfighter': ['super', 'soul', 'fight'],
    'swagg': ['swag'],
    'sweaty': ['sweat'],
    'sweepstakes': ['sweep', 'stake'],
    'swiisha': ['swish'],
    'synyster': ['sinister'],
    'tabz': ['tab'],
    'tacobella': ['taco', 'bell'],
    ...
    'taylorr': ['taylor'],
    'teamwork': ['team', 'work'],
    'tearjerker': ['tear', 'jerk'],
    'tearz': ['tear'],
    'tenpenny': ['ten', 'penny'],
    'terrordome': ['terror', 'dome'],
    'texter': ['text'],
    'tezatalks': ['teza', 'talk'],
    'th2c': ['t', 'h', '2', 'c'],
    'thaiboy': ['thai', 'boy'],
    'thatshymn': ['that', 'shymn'],
    'thc': ['t', 'h', 'c'],
    'the4ewesong': ['the', '4', 'we', 'song'],
    'thicken': ['thick'],
    'thickening': ['thick'],
    'thingsll': ['thing'],
    'thinning': ['thin'],
    ...
    "tho'd": ['throw'],
    'thom': ['tom'],
    'thouxanbanfauni': ['thousand', 'ban', 'fauni'],
    'throo': ['through'],
    'throttleneck': ['throttle', 'neck'],
    'throwaway': ['throw', 'away'],
    'throwaways': ['throw', 'away'],
    'throwbacks': ['throw', 'back'],
    'thunderbitch': ['thunder', 'bitch'],
    'thunderhead': ['thunder', 'head'],
    'thunderpuss': ['thunder', 'puss'],
    'thurzday': ['Thursday'],
    ...
    'torrey': ['torey', 'tory'],
    'tracklab': ['track', 'lab'],
    'tradewinds': ['trade', 'wind'],
    'trafficante': ['traffic'],
    'trapology': ['trap'],
    'trapscat': ['trap', 'scat'],
    'trashwang': ['trash', 'wang'],
    'traveller': ['travel'],
    'treehome': ['tree', 'home'],
    'triller': ['trill'],
    'trillionaire': ['trill'],
    ...
    'turnup': ['turn', 'up'],
    'twelvyy': ['twelve'],
    'twentysomething': ['twenty', 'some', 'thing'],
    'twinz': ['twin'],
    'tymz': ['time'],
    'tysm': ['t', 'y', 's', 'm'],
    'uberx': ['uber', 'x'],
    'udonthav2blonelynomo': ['u', 'dont', 'have', '2', 'be', 'lonely', 'no', 'mo'],
    'ufc': ['u', 'f', 'c'],
    'uglies': ['ugly'],
    'uhohhh': ['uh', 'oh'],
    ...
    'unchanging': ['change'],
    'unclear': ['clear'],
    'undastandz': ['under', 'stand'],
    'underachiever': ['under', 'achieve'],
    'underachievers': ['under', 'achieve'],
    'underarm': ['under', 'arm'],
    'underneathu': ['under', 'u'],
    'understudy': ['under', 'study'],
    'undertones': ['under', 'tone'],
    'unfoolish': ['fool'],
    'unfuckwitable': ['fuck', 'with', 'able'],
    'unghetto': ['ghetto'],
    'unheard': ['heard'],
    'unhidden': ['hidden'],
    'unknowing': ['know'],
    'unkonditional': ['conditional'],
    'unleashed': ['leash'],
    'unloadin': ['load'],
    ...
    'wana': ['wanna'],
    'wanderin': ['wander'],
    'wankerman': ['wanker', 'man'],
    'wannabemceez': ['wanna', 'be', 'm', 'c'],
    'washuwant1': ['wash', 'u', 'want', '1'],
    'watchachacha': ['what', 'cha'],
    'waterslide': ['water', 'slide'],
    'waterslides': ['water', 'slide'],
    'wavewalker': ['wave', 'walk'],
    'waymo': ['way', 'more'],
    'wcsr': ['w', 'c', 's', 'r'],
    'weakness': ['weak'],
    'weeda': ['weed'],
    ...
    'weekender': ['week', 'end'],
    'westland': ['west', 'land'],
    'westworld': ['west', 'world'],
    'wetwork': ['wet', 'work'],
    'whacha': ['what', 'cha'],
    'whaddup': ['what', 'up'],
    'whadown': ['what', 'down'],
    'whalebones': ['whale', 'bone'],
    'whatchulookinat': ['what', 'u', 'look', 'at'],
    'whatyolifelike': ['what', 'yo', 'life', 'like'],
    'wheelin': ['wheel'],
    'whippoorwill': ['whippor', 'will'],
    'whippoorwills': ['whippor', 'will'],
    'whiskeysippi': ['whiskey', 'mississippi'],
    'whisperer': ['whisper'],
    'whn': ['when'],
    'whohasit': ['who', 'has', 'it'],
    ...
    'wht': ['white'],
    'whut': ['what'],
    'whutchacallit': ['what', 'u', 'call', 'it'],
    'whyne': ['whine'],
    'wicced': ['wicked'],
    'wilderado': ['wild'],
    'windowpane': ['window', 'pane'],
    'windshire': ['wind', 'shire'],
    'winicumuhround': ['when', 'i', 'come', 'around'],
    'winterwalk': ['winter', 'walk'],
    'winterworld': ['winter', 'world'],
    'wishery': ['wish'],
    'witcha': ['with', 'cha'],
    'witit': ['with', 'it'],
    'wldlfe': ['wild', 'life'],
    'womanifesto': ['woman', 'manifesto'],
    'womanogamy': ['woman', 'monogamy'],
    'wonda': ['wonder'],
    'wonderbread': ['wonder', 'bread'],
    'wonderchild': ['wonder', 'child'],
    'wordsworth': ['word', 'worth'],
    'worldstop': ['world', 'stop'],
    'wormhole': ['worm', 'hole'],
    'wormholes': ['worm', 'hole'],
    'wowzerz': ['wow'],
    'wrongchilde': ['wrong', 'child'],
    'wstrn': ['west'],
    'wuditlooklike': ['what', 'it', 'look', 'like'],
    'wutchoogonnado': ['what', 'u', 'gonna', 'do'],
    'wutda': ['what'],
    'wutel$e': ['what', 'else'],
    'wutelse': ['what', 'else'],
    'wutup': ['what', 'up'],
    'wwnwhnm': ['w', 'n', 'h', 'm'],
    'xantastic': ['xan', 'fantastic'],
    'xhampagne': ['champagne'],
    'xotic': ['exotic'],
    'xvl': ['x', 'v', 'l'],
    'yabitch': ['ya', 'bitch'],
    ...
    'ym': ['y', 'm'],
    'ymf': ['y', 'm', 'f'],
    'youaremysunshine': ['you', 'are', 'my', 'sun', 'shine'],
    'youu': ['you'],
    'yungniggaz': ['young', 'nig'],
    'yungsnaplorde': ['young', 'snap', 'lord'],
    'yv': ['y', 'v'],
    'yxng': ['young'],
    'zoney': ['zone'],
    'zoul': ['soul'],
    ...
    'latchkey': ['latch', 'key'],
    'alltypeofchnces': ['all', 'type', 'of', 'chance'],
    'livvin': ['livin'],
    'brainfreeze': ['brain', 'freeze'],
    'pronoun': ['pro', 'noun'],
    'priice': ['price'],
    'soulfight': ['soul', 'fight'],
    'dontmakemefallinlove': ['dont', 'make', 'me', 'fall', 'in', 'love'],
    'touchscreen': ['touch', 'screen'],
    'currency': ['currensy'],
    'brakelight': ['brake', 'light'],
    'brakelights': ['brake', 'light'],
    'zookeeper': ['zoo', 'keep'],
    'zookeepers': ['zoo', 'keep'],
    'adulthood': ['adult', 'hood'],
    'playwright': ['play', 'wright'],
    'lowlakes': ['low', 'lake'],
    'grinderman': ['grind', 'man'],
    'ladyfriend': ['lady', 'friend'],
    'ladyfriends': ['lady', 'friend'],
    ...
    'bittersweetheart': ['bitter', 'sweet', 'heart'],
    ...
    'heartstrings': ['heart', 'string'],
    'lightheaded': ['light', 'head'],
    'rattlesnakes': ['rattle', 'snake'],
    'ringmaster': ['ring', 'master'],
    'kompany': ['company'],
    'landlocked': ['land', 'lock'],
    'kelleigh': ['kelly'],
    'loveland': ['love', 'land'],
    'pigz': ['pig'],
    '$hame': ['shame'],
    'honeybody': ['honey', 'body'],
    'sonderlust': ['sonder', 'lust'],
    'flipz': ['flip'],
    'deathless': ['death'],
    'jonny': ['john'],
    'sugaree': ['sugar'],
    ...
    'sleepovers': ['sleep', 'over'],
    'countryfied': ['country'],
    'beetlejuice': ['beetle', 'juice'],
    'beetlejuice!': ['beetle', 'juice'],
    'flexinfab': ['flex', 'fab'],
    'hearteater': ['heart', 'eat'],
    'dropdead': ['drop', 'dead'],
    'toenail': ['toe', 'nail'],
    'netnobody': ['net', 'no', 'body'],
    'doqtor': ['doctor'],
    'iamjakehill': ['i', 'am', 'jake', 'hill'],
    'punchbuzz': ['punch', 'buzz'],
    '#neverusetheinternetagain': ['never', 'use', 'the', 'internet', 'again'],
    'neverusetheinternetagain': ['never', 'use', 'the', 'internet', 'again'],
    'homeboys': ['home', 'boy'],
    'streetgang': ['street', 'gang'],
    'colourblind': ['color', 'blind'],
    'ghost!': ['ghost'],
    'dogwood': ['dog', 'wood'],
    'intangible': ['tangible'],
    'woodpile': ['wood', 'pile'],
    ...
    'highspeeds': ['high', 'speed'],
    'disko': ['disco'],
    'cautionary': ['caution'],
    'hijacker': ['hi', 'jack'],
    'hijackers': ['hi', 'jack'],
    'woo$ah': ['woosah'],
    'noeyeinteam': ['no', 'eye', 'in', 'team'],
    'vanGaalen': ['van', 'gaalen'],
    'canva$': ['canvas'],
    'sammich': ['sandwich'],
    'daymares': ['day', 'mare'],
    'websterx': ['webster', 'x'],
    ...
    'infight': ['in', 'fight'],
    'infighting': ['in', 'fight'],
    'kennyhoopla': ['kenny', 'hoopla'],
    'dreamslave': ['dream', 'slave'],
    'returning': ['return'],
    'headspin': ['head', 'spin'],
    'spookyghostboy': ['spooky', 'ghost', 'boy'],
    'beerbongs': ['beer', 'bong'],
    'tiedup': ['tied', 'up'],
    'tieduprightnow': ['tied', 'up', 'right', 'now'],
    '4ever': ['4', 'ever'],
    'curveball': ['curve', 'ball'],
    'curveballs': ['curve', 'ball'],
    '4am': ['4', 'am'],
    'disloyal': ['loyal'],
    'laptop': ['lap', 'top'],
    'flowerball': ['flower', 'ball'],
    'bandsquad': ['band', 'squad'],
    'maliibu': ['malibu'],
    'miitch': ['mitch'],
    'facey': ['face'],
    'joness': ['jones'],
    'bleublk': ['blue', 'black'],
    '7eventhirty': ['7', 'thirty'],
    'trustfall': ['trust', 'fall'],
    'zzzzz': ['z'],
    'sellout': ['sell', 'out'],
    'secondsex': ['second', 'sex'],
    'drxquinnx': ['doctor', 'x', 'quinn'],
    '88rising': ['8', 'rise'],
    'technicolor': ['techni', 'color'],
    'wh0': ['who'],
    'steppa': ['step'],
    'blackgummy': ['black', 'gummy'],
    'notaker': ['no', 'take'],
    'jetfire': ['jet', 'fir'],
    'charmes': ['charm'],
    'awoltalk': ['awol', 'talk'],
    ...
    'fangclub': ['fang', 'club'],
    'unheavenly': ['heaven'],
    'tigersblood': ['tiger', 'blood'],
    'tigerblood': ['tiger', 'blood'],
    'standstill': ['stand', 'still'],
    'standstills': ['stand', 'still'],
    'sundancer': ['sun', 'dance'],
    'roarin': ['roar'],
    'underpass': ['under', 'pass'],
    'overpass': ['over', 'pass'],
    'devildriver': ['devil', 'drive'],
    'lovehappy': ['love', 'happy'],
    'sorcererz': ['sorcerer'],
    'bloodiest': ['blood'],
    'freeee': ['free'],
    'voicenotes': ['voice', 'note'],
    'shyspeaks': ['shy', 'speak'],
    'nobigdyl': ['no', 'big', 'deal'],
    'feathered': ['feather'],
    'dontbenobodysbitch': ['dont', 'be', 'no', 'body', 'bitch'],
    'soarin': ['soar'],
    "boo'd": ['boo'],
    'belaire': ['bel', 'air'],
    'teddy<3': ['ted'],
    ...
    'pettywap': ['petty', 'wap'],
    'yk': ['y', 'k'],
    'millidelphia': ['mill', 'philadelphia'],
    'apeshit': ['ape', 'shit'],
    'reborn': ['born'],
};
    ...
    fetchDashboard: (token) => {
        return dispatch => {
            ...
            return fetch(`${baseUrl}/api/v1/dashboard?app_id=${appId}&access_token=${token}`, {
                ...
                return dispatch(site_1._fetchDashboardSuccess({
                    previews: groups,
                    invites: json.invites.map(invite => types_1.DashboardGamePreview.from(invite))
                }));
            })
                .catch(error => {
                console.log(error);
